...
from data.base_dataset import BaseDataset, get_params, get_transform, get_transform_instance
...
class Pix2pixDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt.no_instance:
            ...
            instance = np.squeeze(instance, axis=(1, 2, 3))
            instance = np.array(instance, dtype=np.float32)
            #print(np.shape(instance))

            transform_instance = get_transform_instance()
            instance_tensor = transform_instance(instance)
            instance_tensor.squeeze(0)
