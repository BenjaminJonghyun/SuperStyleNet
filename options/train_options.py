...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # for displays
        parser.add_argument('--display_freq', type=int, default=2970, help='frequency of showing training results on screen')
        parser.add_argument('--print_freq', type=int, default=2970, help='frequency of showing training results on console')
        parser.add_argument('--save_latest_freq', type=int, default=2970, help='frequency of saving the latest results')
